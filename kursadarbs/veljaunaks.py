...
def main():
    ...
    print()
    print("Sveiki! Atbildot uz jautājumiem, uzzināsiet, kura disciplīna ir piemērotāka Jūsu zirgam!")
    f.write("Sveiki! Atbildot uz jautājumiem, uzzināsiet, kura disciplīna ir piemērotāka Jūsu zirgam!!" + "\n")
    print()
    ...
    if o == 2:
        ...
        print(zirgs)
        print(
            f"Ēdināšanas grafiks: Jādod auzas {bariba['auzas']}, siens {bariba['siens']}, musli {bariba['musli']} un vitamīni {bariba['vitamīni']}. ")
        f.write(
            "fĒdināšanas grafiks: Jādod auzas {bariba['auzas']}, siens {bariba['siens']}, musli {bariba['musli']} un vitamīni {bariba['vitamīni']}. " + "\n")

    print()

    print(
        "Jums ir iespēja laimēt loterijā. Noteikumi: programma ģenerē random skaitļus, līdz kamēr tas ir 7. Ja izvada 5 skaitļus un vairāk, tad Jūs laimējat zirgu gardumus! Ja izvada 4 skaitļus un mazāk, tad diemžēl neko nelaimējāt. ")
    f.write(
        "Jums ir iespēja laimēt loterijā. Noteikumi: programma ģenerē random skaitļus, līdz kamēr tas ir 7. Ja izvada 5 skaitļus un vairāk, tad Jūs laimējat zirgu gardumus! Ja izvada 4 skaitļus un mazāk, tad diemžēl neko nelaimējāt. " + "\n")
    ...
    print(
        "Tika atrasts {0}.  Ja pēc noteikumiem laimējāt balvu, tad attiecīgi sazināsimies ar Jums caur e-pastu.".format(
            y))
    f.write(
        "Tika atrasts {0}.  Ja pēc noteikumiem laimējāt balvu, tad attiecīgi sazināsimies ar Jums caur e-pastu.format(y)" + "\n")
